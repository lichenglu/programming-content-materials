...
* Have your TAs reference [4.1-TimeTracker](4.1-TimeTracker.xlsx) to help keep track of time during class.
...
* Proceed with the first demonstration of class: `1-JSGenerators`. In this first demo, you will show students how to modify the DOM using vanilla JavaScript. In later portions of the class, you will re-do this activity using jQuery.
...
* **File:**
  ...
  * [drink-list-unsolved.html](Activities/2-JSDrinkList/Unsolved/drink-list-unsolved.html)
...
* Now return to the example completed before. But this time, use jQuery (`3-jQueryGenerators`).
...
* **File:**
  ...
  * [jquery-drink-list-unsolved.html](Activities/4-jQueryDrinkList/Unsolved/jquery-drink-list-unsolved.html)
...
* Open the file [`onclick.html`](Activities/5-OnClickBasic/onclick.html). Then walk students through the syntax for `on-click` events. Specifically, point out how:
...
* **File:**
  ...
  * [sandwich-click-unsolved.html](Activities/6-SandwichClick/Unsolved/sandwich-click-unsolved.html)
...
* **File:**
  ...
  * [trigger-random-unsolved.html](Activities/7-TriggerRandom/Unsolved/trigger-random-unsolved.html)
...
* **File:**
  ...
  * [trigger-random-unsolved.html](Activities/7-TriggerRandom)
